...
const CurrencyConvert_1 = require("./pages/currecyConvert/CurrencyConvert");
const NotFound_1 = require("./pages/NotFound");
const Rates_1 = require("./pages/rates/Rates");
const Registration_1 = require("./pages/registry/Registration");
const Autorisation_1 = require("./pages/autorisation/Autorisation");

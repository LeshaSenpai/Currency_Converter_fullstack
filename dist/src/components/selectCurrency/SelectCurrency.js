...
const SelectCurrency = (0, mobx_react_lite_1.observer)(({ onSelect, defaultCode }) => {
    const { items, toggleFavorite } = CurrencyStore_1.currencyStore;
